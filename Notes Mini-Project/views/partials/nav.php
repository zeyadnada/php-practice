             ...
             <div class="flex items-center">
                 ...
                 <div class="hidden md:block">
                     <div class="ml-10 flex items-baseline space-x-4">
                         ...
                         <a href="/"
                             class="<?= (isCurrentPage('/')) ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Home</a>
                         <a href="/about"
                             class="<?= (isCurrentPage('/about')) ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">About</a>
                         </a>

                         <?php if ($_SESSION['user'] ?? false) : ?>
                         <a href="/notes"
                             class="<?= (isCurrentPage('/notes')) ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Notes</a>
                         </a>
                         <?php endif; ?>

                         <a href="/contact"
                             class="<?= (isCurrentPage('/contact')) ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Contact</a>
                     </div>
                 </div>
             </div>
             <div class="hidden md:block">
                 <div class="ml-4 flex items-center md:ml-6">
                     ...
                     <el-dropdown class="relative ml-3">
                         ...
                         <?php else: ?>
                         <a href="/login"
                             class="text-gray-300 hover:bg-white/5 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Login</a>

                         <a href="/register"
                             class="text-gray-300 hover:bg-white/5 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Register</a>
                         <?php endif; ?>
                     ...
                     <div class="ml-3">
                         <form action="/session" method="POST">
                             ...
                             <button type="submit"
                                 class="text-red-300 hover:bg-white/5 hover:text-red rounded-md px-3 py-2 text-sm font-medium">Logout</button>
                         </form>
                     </div>
                     <?php endif; ?>
